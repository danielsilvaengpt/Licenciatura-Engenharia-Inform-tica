function tarefa_c_ii()
    ...
    [p, t] = loadImagensGeometricas('test');  % Esta função deve carregar imagens da pasta "test"

    nomeFicheiro = '../Tarefa_b/rede_2.mat';  % rede_1.mat , rede_2.mat , rede_3.mat
